...
use seekquarry\yioop\src\configs as C;
   ...
   public static function tagTokenizePartOfSpeech($text)
    {
        static $dictionary = [];
        if (empty($dictionary)) {
            $fh = gzopen("vendor/seekquarry/yioop/src/locale/en_US/resources/lexicon.txt.gz", 'r');
     ...
     * @return the compressed sentence
     */
    public static function numberTwo($sentence_to_compress)
    {
        $result = $sentence_to_compress;
     ...
     * @return the compressed sentence
     */
    public static function numberThree($sentence_to_compress)
    {
        $result = $sentence_to_compress;
     ...
     * @return the compressed sentence
     */
    public static function numberFour($sentence_to_compress)
    {
        $result = $sentence_to_compress;
     ...
     * @return the compressed sentence
     */
    public static function numberSix($sentence_to_compress)
    {
        $result = $sentence_to_compress;
...
$tok = new Tokenizer;
$tok->tagPartsOfSpeechPhrase($phrase);